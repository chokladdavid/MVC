...
namespace MVC_Lab_4_Ajax.Controllers
{
    public class TestingController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,CourseName,GradeValue")] Grade grade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,CourseName,GradeValue")] Grade grade)
        {
            if (ModelState.IsValid)
            {
